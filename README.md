...
- `/instituicao` — portal da instituição (saldo on-chain, score, saque PJ e notas fiscais)
...
No portal `/instituicao`, entre como Casa da Mulher. O dashboard exibe saldo em R$ e USDC, o score de transparência, saque para conta PJ (gera pendência) e pagamento a fornecedor com NF. Anexar recibo fecha a cadeia e atualiza a trilha pública.
